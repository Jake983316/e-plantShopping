...
function ProductList() {
    ...
    const totalCartItems = useSelector((state) => state.cart.items.reduce((acc, item) => acc + item.quantity, 0));
            ...
            <div style={styleObjUl}>
                ...
                <div> 
                    <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            <h1 className='cart_quantity_count'>{totalCartItems}</h1>
                            ...
                            {category.plants.map((plant, plantIndex) => {
                                ...
                                return (                             
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button className="product-button" onClick={() => handleAddToCart(plant)} disabled={isPlantAddedToCart}>{isPlantAddedToCart ? "Added to cart" : "Add to cart"}</button>
                                    </div>
                                )
                            })}
                        </div>
